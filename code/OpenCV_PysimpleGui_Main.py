...
if __name__ == '__main__' : 
    multiprocessing.Process(target=gui, args=(window,from_gui,to_gui,), name='gui').start()
    ...
    while True:
        ...
        if video.defined :
            ...
            if video.totframe > 0 :
                to_gui_list.append(['video-progress',int((100/video.totframe)*video.framenum)])
        #Video-------------------------------------------------------------------------------------
            ...
            case 'video':
                ...
                match eventsplit[1] :
                    ...
                    case 'startfile' : 
                        ...
                        to_gui_list.append(['video-info',video_info])
